...
import cs516.gabrielGheorghian.dnd.TableRowTransferHandler;
...
public class MailTable extends JPanel {
	...
	private MailReceiveDisplay mailMessagePanel = null;
	private MailTableModel mailTableModel = null;
	private JScrollPane scrollPane;
	private int currentRow;
	
	public MailTable(MailReceiveDisplay receivingPanel, MailTableModel mailTableModel) {
		super();
		setLayout(new BorderLayout());
		this.mailMessagePanel = receivingPanel;
	...
	private void initialize() {
		...
		JTable table = new JTable(mailTableModel);
	...
	class RowListener implements ListSelectionListener {
		...
		public void valueChanged(ListSelectionEvent e) {
			...
			if (!lsm.isSelectionEmpty()) {
				...
				mailMessagePanel.displayMessage(mailTableModel.getMailMessageData(currentRow));
			}
		}
	}
