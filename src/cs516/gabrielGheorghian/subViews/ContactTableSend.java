...
public class ContactTableSend extends JPanel {
	private static final long serialVersionUID = 1L;
	private MailSendDisplay sendPanel = null;
	private ContactTableModelSend contactTableModel = null;
	private JScrollPane scrollPane;
	private int currentRow;

	public ContactTableSend(MailSendDisplay sendPanel,
			ContactTableModelSend contactTableModel) {
		super();
	...
	class RowListener implements ListSelectionListener {
		...
		public void valueChanged(ListSelectionEvent e) {
			...
			if (!lsm.isSelectionEmpty()) {
				...
				sendPanel.addContact(contactTableModel
						.getContactData(currentRow));
			}
		}
	}
